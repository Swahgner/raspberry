...
def fire():
  ...
  while(True):
    ...
    if(i<1):
      ...
      sense.set_pixel(4, 3, randomColor)
      sense.set_pixel(3, 3, randomColor)
      time.sleep(0.3)
      sense.set_pixel(3, 2, randomColor)
      sense.set_pixel(5, 2, randomColor)
      sense.set_pixel(1, 2, randomColor)
      time.sleep(0.3)
      sense.set_pixel(3, 1, randomColor)
      sense.set_pixel(6, 1, randomColor)
      sense.set_pixel(0, 1, randomColor)
      time.sleep(0.3)
      sense.set_pixel(3, 0, randomColor)
      sense.set_pixel(7, 0, randomColor)
      sense.clear()
